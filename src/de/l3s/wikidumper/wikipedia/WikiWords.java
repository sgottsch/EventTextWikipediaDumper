package de.l3s.wikidumper.wikipedia;
	...
	public void init(List<Language> languages) {
		...
		for (Language language : languages) {
			...
			try {
				...
				if (this.words == null) {
					br = new BufferedReader(new InputStreamReader(this.getClass().getResourceAsStream(
							"/resource/meta_data/wikipedia/" + language.getLanguage() + "/words.txt")));
				} else
